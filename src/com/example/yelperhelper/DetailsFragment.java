...
//		
		...
		Button button = (Button) findViewById(R.id.details_buttonCall);
		button.setText((CharSequence) restaurant.getPhone());
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				CharSequence number =(CharSequence) restaurant.getPhone();
		...
		TextView details_reviews = (TextView) findViewById(R.id.details_reviews);
		details_reviews.setText((CharSequence) restaurant.getReview_count().toString()+"Reviews");
